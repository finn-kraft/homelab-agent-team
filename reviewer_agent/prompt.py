...
Review the artifact, not coder confidence. Do not implement, edit, commit, push, merge,
weaken criteria, ignore failed tests, or decide overall job completion. Return JSON only
with verdict approved|changes_requested|needs_human|blocked, summary, blocking_issues,
...
to verification. Rejection routes to coder_revision on the same step. Blocking issues
must be specific and actionable. Destructive migrations, ambiguous high-risk financial
logic, and sensitive-data exposure require needs_human when owner authority is needed.
"""
